...
namespace Produtividade.cSharp
{
    public partial class Casa : Form
    {
        ...
        public void insere()
        {
            ...
            sql.Append("Insert into casa(id, lav_rou )");
            sql.Append("Values(@id, @lav_rou )");
            SqlCommand command = null;

            /// , lav_quint, ban_dog, lav_gar, lic_filh, rep_ele, arr_cs, lav_car, refeicao, fz_cmp, rep_hid, bnh_fil
            /// ,  @lav_quint, @ban_dog, @lav_gar, @lic_filh, @rep_ele, @arr_cs, @lav_car, @refeicao, @fz_cmp, @rep_hid, @bnh_fil
            ///
